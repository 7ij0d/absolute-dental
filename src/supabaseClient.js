...
const defaultProducts = [
  ...
  },
  {
    ...
    subject_id: '23',
    year_id: '2',
    name_ar: 'أسنان اصطناعية - الضرس الأول السفلي (Lower First Molar)',
    name_en: 'Artificial Tooth - Lower First Molar (Crown Prep Typodont)',
    description_ar: 'سن ضرس اصطناعي سفلي أول لمعمل التيجان، يستخدم في التدريب على تجهيز السطوح الخمسة للتاج الكامل وحفر الإطباق.',
    description_en: 'Lower first molar typodont tooth for complete crown preparation training — all 5 surfaces including occlusal anatomy.',
    details_ar: '• راتنج عالي الكثافة مقاوم للاهتراء\n• تشريح دقيق للحدبات والأخاديد السفلية\n• سطح خارجي مناسب للتشكيل بمختلف أنواع السنابل\n• القطعة = سنٌّ واحد',
    details_en: '• High-density wear-resistant resin\n• Precise lower molar cusp and groove anatomy\n• Suitable for preparation with all bur types\n• Sold per tooth',
    price: 2.00,
    compare_at_price: null,
    discount_label_ar: null,
    discount_label_en: null,
